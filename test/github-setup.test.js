...
assert.match(workflow, /npm run test:certification/, 'Workflow should run the focused certification custody and protocol gate');
...
assert.strictEqual(pkg.scripts['test:certification'], 'node test/run-all.js test/certification.test.js test/certification-isolation.test.js test/certification-lifecycle.test.js test/artifact-resource-scope.test.js test/compute-artifact-custody.test.js test/execution-node-protocol.test.js', 'focused certification script should cover certification, custody, and protocol suites');
