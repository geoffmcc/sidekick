...
(async () => {
  try {
    ...
    const completedRun = kernel.transitionResearchTestRun(run.test_run_id, 'completed', { actor_id: 'test-operator', outcome: 'inconclusive', evidence: [`artifact:${artifact.artifact_id}`] });
