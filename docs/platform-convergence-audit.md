...
| Workflows | IMPLEMENTED BUT PARTIAL | kernel workflow methods, Brain runner | `platform_workflows`/steps; workflow tests | Ordered steps/checkpoints/pause/retry state work; no common runner/branching/compensation contract. |
