...
consumption) and the B7 keystone. **B6** is complete for custody, with artifact
access authorization deferred to the Track C identity boundary. B8 remains open
and is a separate future campaign — none of them was touched by that
