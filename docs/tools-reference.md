...
This catalog is generated from `TOOL_DEFS` in `src/tools.js`. The current code exports 91 built-in tool handlers. Most tools return MCP content blocks containing text. Errors usually set `isError: true` and include an explanatory text result.
