...
// Restrict the credential file to the current user only: disable ACL
// inheritance, drop inherited ACEs, and grant the running account full control.
...
module.exports = { defaultCredentialPath, applyWindowsAcl, save, load, WORKER_ID_RE, CREDENTIAL_RE };
