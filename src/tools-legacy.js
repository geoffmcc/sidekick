...
const TOOL_DEFS = [
  ...
  { name: "llm", description: "Ask the LLM via Compute (provider and model are chosen by routing; private by default)", args: { prompt: "string", system: "string (optional)", temperature: "number (optional)", async: "boolean (optional)", timeout_ms: "integer (optional, async execution timeout)", max_tokens: "integer (optional, output segment limit)" } },
