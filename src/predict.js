...
const { ensureSchema, RULE_VERSION, LEGACY_RULE_VERSION } = require("./predict/schema");
const { normalizeToolLog, boundaryId, buildSequences, resolveScope, VALID_SCOPES } = require("./predict/sequences");
const {
  smoothScore, calculateBaseRate, calculateConfidence, calculateScore,
