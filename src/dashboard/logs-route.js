...
function registerLogsRoute({ app, dbStore, normalizeLogEntry, buildActivitySessions, summarizeActivity, fallbackGapMs }) {
  app.get("/api/logs", (req, res) => {
    ...
    res.json({ entries, sessions, summary: summarizeActivity(sessions, entries), total: entries.length, fallback_grouping_ms: fallbackGapMs });
  });
}
