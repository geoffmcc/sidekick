...
function registerPredictRoutes({ app, predictEngine, governedDashboardMutation }) {
  ...
  app.get("/api/predict/maintenance/diagnose", (req, res) => res.json(predictEngine.diagnose()));
