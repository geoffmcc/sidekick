...
async function sidekick_log_query({ tool, source, success, since, until, project, session_id, task_id, correlation_id, limit }) {
  try { return jsonResult(dbStore.queryToolLogs({ tool, source, success, since, until, project, session_id, task_id, correlation_id, limit: limit || 100 })); }
  catch (e) { return errorResult(e); }
}
