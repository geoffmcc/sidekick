...
async function sidekick_log_query({ tool, source, success, since, until, limit }) {
  try { return jsonResult(dbStore.queryToolLogs({ tool, source, success, since, until, limit: limit || 100 })); }
  catch (e) { return errorResult(e); }
}
