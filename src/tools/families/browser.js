...
const argsDoc = {
  ...
  network_scope: "string (open: exact operator-created named outbound network scope; required for private research access)",
  allow_private_network: "boolean (deprecated compatibility flag; cannot grant private access without network_scope)",
