...
function assertExperimentalEnvironment() {
  if (process.env.NODE_ENV === "production" && process.env.SIDEKICK_ENABLE_EXPERIMENTAL_IDENTITY_DEPLOYMENT !== "true") {
    throw new Error("identity-deployment is experimental and disabled in production; use the durable identity authority");
  }
}
