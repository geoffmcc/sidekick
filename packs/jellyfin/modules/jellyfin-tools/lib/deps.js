 ...
 * repository (SIDEKICK_DATA_DIR is not the repo checkout), so a bare
 * `require("zod")` is not guaranteed to resolve from here. Resolve against the
 * running Sidekick installation as a fallback rather than vendoring a second
 * copy of a dependency Sidekick already loads.
 */
